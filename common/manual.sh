...
if [ -d $IMGDIR/$id ]; then
    ...
    ln -sf $IMGDIR/$id/rclone /system/xbin/rclone
    ln -sf $IMGDIR/$id/fusermount /system/xbin/fusermount3

else

    ln -sf $MODDIR/rclone /system/xbin/rclone
    ln -sf $MODDIR/fusermount /system/xbin/fusermount3
